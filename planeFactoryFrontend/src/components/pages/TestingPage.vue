    ...
    <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
      ...
      <form id="form" novalidate>
        ...
        <div class="flex flex-row space-x-4">
          ...
          <div class="relative z-0 w-full">
            <input
              ...
              class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
            />
            <label for="time" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500"
              >Time</label
            >
        ...
        <div class="relative z-0 w-full mb-5">
          ...
          <label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500"
            >Amount</label
          >
        ...
        <div class="relative z-0 w-full mb-5">
          ...
          <label for="duration" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500"
            >Duration</label
          >
